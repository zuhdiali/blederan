                    ...
                    <tr>
                      <td>
                        <div class="d-flex flex-column align-self-center">
                          <div class="p-1">
                            <a href="{{url('admin-edit-produk', $akomodasi->id)}}" class="btn btn-primary" title="Edit">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                Apakah Anda yakin ingin menghapus produk <strong>{{$akomodasi->nama_produk}}</strong> dari {{$akomodasi->nama_pemilik}}?
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batalkan</button>
                                <form action="{{url('admin-hapus-produk/'.$akomodasi->id)}}">
                      ...
                      <th scope="row">{{$akomodasi->nama_produk}}</th>
                      <td>{{$akomodasi->harga}}</td>
                      <td>{{$akomodasi->stok}}</td>
                      <td>{{$akomodasi->nama_pemilik}}</td>
                      <td>{{$akomodasi->kontak_pemilik}}</td>
                      <td>
                        <img src="{{asset('uploads/produk/'.$akomodasi->gambar_produk)}}" alt="gambar produk" width="100px">
                      </td>
